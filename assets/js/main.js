...
tabs.forEach(tab => {
    tab.addEventListener('click', () => {
        ...
        tabContents.forEach(tabContents => {
            tabContents.classList.remove('qualificacao_active')
        })
        target.classList.add('qualificacao_active')

        tabs.forEach(tab => {
            tab.classList.remove('qualificacao_active')
        })
        tab.classList.add('qualificacao_active')
    })
})
